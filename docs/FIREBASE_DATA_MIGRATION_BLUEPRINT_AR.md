...
**الإصدار المرجعي:** v1.6.0
**الحالة:** بُنيت طبقة الترحيل والتخزين والأرشفة في التطبيق، لكنها لا تبدأ النقل من تلقاء نفسها. تظل الوثيقة القديمة هي مصدر القراءة والكتابة التشغيلي إلى أن ينفذ مدير العيادة معاينة ثم يوافق صراحة على إنشاء نسخة V2 ومراجعة التقرير.
...
| ترحيل V2 | تُنشأ وثائق مستقلة للمرضى والزيارات والمواعيد والفواتير والروشتات والمصروفات والإعدادات والقوائم في دفعات من 400 | لا يُشغّل من دون اتصال أو حساب مدير أو نافذة تأكيد؛ ولا يحذف الوثيقة القديمة |
...
| الأرشفة | يمكن أرشفة عرض المواعيد القديمة واستعادتها، وتبقى الزيارة والموعد المكتمل محفوظين | لا يوجد حذف تلقائي للمرضى أو الزيارات أو الروشتات أو قائمة الانتظار |

> بعد إنشاء نسخة V2، يبقى التطبيق في وضع **القراءة والكتابة القديمة**. هذه خطوة مقصودة؛ التحويل النهائي للقراءة يتطلب تقرير مطابقة مفصل واختباراً دون اتصال على نسخة اختبارية أولاً.
